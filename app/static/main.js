...
$(".navbar-mobile").on("click", function () {
  if ($("body").hasClass("active-nav")) {
    ...
    $(".nav-link-item").css("margin-bottom", "0");
    console.log($(".navlink-item"));
  } else {
    $("body").addClass("active-nav");
    Object.values($(".nav-link-item"));
    for (let i = 0; i < Object.values($(".nav-link-item")).length - 3; i++) {
      Object.values($(".nav-link-item"))[i].style.marginBottom = `${
        Object.values($(".nav-link-item"))[i].children[1].offsetHeight
      }px`;
    }
  }
});
